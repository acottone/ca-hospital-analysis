...
# Load the dataset
data = pd.read_csv('number-of-cancer-surgeries-volume-performed-in-california-hospitals-.csv', encoding='ISO-8859-1')
...
data.to_csv('22_2013-2023_processed_ca_hospital_cancer_surgeries_volume_data.csv', index=False)
